...
const addresses = [
	...
	{
		name: "Jane Smith",
		email: "Demond59@hotmail.com",
		address:
			"Shop No 6 Sakuntal Complex Kala Darshan Char Rasta, Waghodiya Road, Vadodara, Gujarat 390019",
		city: "Los Angeles",
		state: "CA",
		postalCode: "90001",
	},
		...
		<div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
			<div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
				...
				<div className="lg:col-span-2">
					<div className="mx-auto md:mt-12  bg-white max-w-7xl px-4 sm:px-6 lg:px-4 position: fixed rounded-md">
						<h1 className="text-xl font-bold tracking-tight text-gray-900 pt-12 m mb-4 ml-4">
							Cart
						</h1>
											...
											<div className="ml-4 flex flex-1 flex-col">
												...
												<div className="flex flex-1 items-end justify-between text-sm">
													<div>
														...
														<select className="ml-1.5 text-xs py-1 pr-8 rounded-lg ">
															<option
																className="text-xs"
																value="1"
															>
